...
export default function PharmacyQueuePage() {
  ...
  const startDispense = (patientUuid: string, queueUuid: string) => {
    router.push(`/opd/dispense?patientUuid=${encodeURIComponent(patientUuid)}&queueUuid=${encodeURIComponent(queueUuid)}`);
  };
              ...
              <TableBody>
                {list.map((e) => (
                  <TableRow key={e.uuid}>
                    ...
                    <TableCell><Button size="sm" onClick={() => startDispense(e.patient.uuid, e.uuid)}>Start Dispense</Button></TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
